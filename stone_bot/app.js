...
const res1 = "___ бросил камень в ---.";
const res2 = "Вы можете бросить камень в того самого пользователя только 3 раза за 24 часа.";
const res3 = "Вы не можете бросить камень в самого себя.";
const res4 = "В пользователя ___ бросили камень --- раз.";
